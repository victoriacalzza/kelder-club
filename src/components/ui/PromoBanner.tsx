  ...
  return (
    <div className="overflow-hidden rounded-2xl border border-ink-100 bg-white">
      <div className="flex flex-col md:min-h-[360px] md:flex-row">
        ...
        <div className="h-64 w-full overflow-hidden bg-ink-50 md:h-auto md:w-1/2">
          {campania.imagen && (
            <img
              src={campania.imagen}
        ...
        <div className="flex flex-1 flex-col justify-center gap-4 p-8 sm:p-12">
          ...
          <p className="text-4xl font-semibold leading-[1.05] tracking-tight text-ink-900 sm:text-5xl">{campania.titulo}</p>
